...
namespace SpecFlowBdd.Features
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("Calculator", Description="In order to test my application\r\nAs a developer\r\nI want to validate different ope" +
        "rations of the application", SourceFile="Features\\Calculator.feature", SourceLine=0)]
